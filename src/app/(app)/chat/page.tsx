              ...
              {camera.capturedUrl ? (
                ...
                <div className="flex items-center gap-12 w-full justify-center px-8">
                  ...
                  <button
                    ...
                    className={`w-12 h-12 rounded-full bg-white/10 flex items-center justify-center transition-colors active:scale-95 ${camera.isTorchOn ? "text-yellow-400 bg-white/20" : "text-white"
                      }`}
                  >
                    {camera.isTorchOn ? <Zap size={24} /> : <ZapOff size={24} />}
                  </button>
                  ...
                  <motion.button
                    ...
                    className="w-20 h-20 rounded-full bg-white border-4 border-white/40 shadow-lg shrink-0"
                  />

                  {/* Flip Camera */}
                  <button
                    onClick={camera.flipCamera}
                    className="w-12 h-12 rounded-full bg-white/10 text-white flex items-center justify-center transition-transform active:scale-95"
                  >
